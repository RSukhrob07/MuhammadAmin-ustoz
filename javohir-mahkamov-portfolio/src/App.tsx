  ...
  return (
    <div id="portfolio-root" className="min-h-screen bg-[#0B0A0F] text-neutral-100 font-sans selection:bg-[#FF6B00]/30 selection:text-white relative overflow-x-hidden antialiased">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16 flex flex-col items-center">
          ...
          <div className="lg:col-span-4 flex flex-col justify-between">
            <div className="relative group w-full h-[400px] sm:h-[480px] lg:h-[580px] rounded-2xl overflow-hidden border border-neutral-800 bg-[#121118]/80 shadow-[0_0_40px_-15px_rgba(255,107,0,0.25)] flex items-center justify-center transition-all duration-500 hover:border-[#FF6B00]/40">
              ...
              {teacherData.teacherImg && teacherData.teacherImg.trim() !== "" ? (
                ...
                <div className="w-full h-full bg-gradient-to-br from-[#1C1A27] to-[#121118] flex flex-col items-center justify-center gap-4 select-none">
                  <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-[#FF6B00]/15 to-violet-500/15 border border-neutral-800 flex items-center justify-center text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#FF9E4A] to-[#FF6B00] tracking-wider shadow-inner">
                    {getInitials(teacherData.name)}
                  </div>
                  <span className="text-[10px] text-neutral-500 font-bold tracking-[3px] uppercase">PORTRAIT OF TEACHER</span>
                </div>
              )}
        ...
        {/* Harakat tugmalari (Original linklar) */}
      ...
      {/* MODAL: Video Lavhalar & Test (Interaktivlik uchun saqlab qolingan) */}
      {activeModal === 'video' && (
